...
export class Migration1760309038764 implements MigrationInterface {
    name = 'Migration1760309038764'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "appoinment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "appointmentAt" TIMESTAMP NOT NULL, "originalUrl" character varying, "processedUrl" character varying, "contactTotalPct" double precision NOT NULL DEFAULT '0', "forefootPct" double precision NOT NULL DEFAULT '0', "midfootPct" double precision NOT NULL DEFAULT '0', "rearfootPct" double precision NOT NULL DEFAULT '0', "note" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "patientId" uuid, "doctorId" uuid, CONSTRAINT "PK_0f601bf52822a9fc4cae433ef8b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "session_data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "p1" double precision NOT NULL, "p2" double precision NOT NULL, "p3" double precision NOT NULL, "ax" double precision NOT NULL, "ay" double precision NOT NULL, "az" double precision NOT NULL, "gx" double precision NOT NULL, "gy" double precision NOT NULL, "gz" double precision NOT NULL, "recordedAt" TIMESTAMP NOT NULL, "sessionId" uuid, CONSTRAINT "PK_791c7014ec3aa653c58410c14e8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "appoinment" ADD CONSTRAINT "FK_44aea2b478853005eb117396129" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "appoinment" ADD CONSTRAINT "FK_f379e47e169fbff0419a31b8fbf" FOREIGN KEY ("doctorId") REFERENCES "doctors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "appoinment" DROP CONSTRAINT "FK_f379e47e169fbff0419a31b8fbf"`);
        await queryRunner.query(`ALTER TABLE "appoinment" DROP CONSTRAINT "FK_44aea2b478853005eb117396129"`);
        ...
        await queryRunner.query(`DROP TABLE "appoinment"`);
